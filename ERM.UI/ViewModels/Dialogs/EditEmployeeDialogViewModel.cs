...
namespace ERM.UI.ViewModels.Dialogs
{
    public class EditEmployeeDialogViewModel : ViewModelBase
    {
        ...
        {
            get => _fullName;
            set { SetField(ref _fullName, value); OnPropertyChanged(nameof(IsValid)); }
        }
        ...
        {
            get => _phoneNumber;
            set { SetField(ref _phoneNumber, value); OnPropertyChanged(nameof(IsValid)); }
        }
        ...
        {
            get => _notes;
            set { SetField(ref _notes, value); OnPropertyChanged(nameof(IsValid)); }
        }
        ...
        {
            get => _isSeamstress;
            set { SetField(ref _isSeamstress, value); OnPropertyChanged(nameof(IsValid)); }
        }
        ...
        {
            get => _machineNumber;
            set { SetField(ref _machineNumber, value); OnPropertyChanged(nameof(IsValid)); }
        }
